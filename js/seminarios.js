const seminarios = [
    ...
    {
        slug: 'conductas-proambientales',
        titulo: 'De la Indiferencia a la Acción',
        subtitulo: 'Herramientas para comprender y favorecer el cambio de comportamiento ambiental',
        icono: 'brain-circuit',
        duracion: '2.5 horas (150 min)',
        modalidad: 'Webinar / Presencial',
        audiencia: 'Técnicos y profesionales ambientales',
        nivel: 'Intermedio-Aplicado',
        badges: ['Psicología Ambiental', 'Marketing Social'],
    },
    {
        slug: 'ingenieria-del-compostaje',
        titulo: 'Ingeniería del Compostaje y NTC 5167',
        subtitulo: 'Valorización de residuos orgánicos: operación técnica, control de calidad y conformidad normativa',
        icono: 'sprout',
        duracion: '2.5 horas (150 min)',
        modalidad: 'Web',
        audiencia: 'Técnicos y gestores RSU',
        nivel: 'Técnico-Aplicado',
        badges: ['Economía Circular', 'NTC 5167'],
    },
];
